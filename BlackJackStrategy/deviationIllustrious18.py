...
def deviation(playerHand, dealerCard):
    ...
    if playerHand[0] == 10 and dealerCard == 6 and handIsPair(playerHand) and not handIsSoft(playerHand) and trueCount >= 6:
        return True, "Split!"
    else:
        pass
    ...
    if playerHand[0] == 10 and dealerCard == 6 and handIsPair(playerHand) and not handIsSoft(playerHand) and trueCount >= 4:
        return True, "Split!"
    else:
        pass
